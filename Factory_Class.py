class Factory:
    ...
    def set_factory(self, material, raw_material_dict):
        ...
        :return: nothing                                                                                      
        """
        # if a factory is set to false then set that factory to build the material and set the production to \
how ever much the recipe produces                                                                             
    ...
    def display(self):
        ...
        if self.set == True:
            print("\t\t{} Factory producing {} per turn, total production {} Factory".format(self.producing, \
self.production, self.total_production))
